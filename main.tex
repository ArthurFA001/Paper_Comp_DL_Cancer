...
Para los modelos de Redes Neuronales de Grafos (GNN), se implementaron dos arquitecturas distintas para evaluar su capacidad de capturar relaciones biológicas en los datos multiómicos integrados.
