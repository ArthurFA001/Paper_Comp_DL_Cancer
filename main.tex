...
Para evaluar la capacidad de las GNN en la integración de datos multiómicos, se implementaron tres arquitecturas distintas: una basada en Redes Neuronales Convolucionales de Grafos (GCN), otra en Redes de Atención de Grafos (GAT) y una tercera en Redes de Transformadores de Grafos (GTN).
